...
const InvoiceForm = () => {
  ...
  useEffect(() => {
    if (!invoiceData.invoice.number) {
      const randomNumber = `3DYC-${Math.floor(
        ...
        <div className="row g-3 ">
          ...
          <div className="col-md-12  ">
            <input
              ...
              onChange={(e) =>
                handelChange("company", "address", e.target.value)
              }
        ...
        <div className="row g-3 ">
          ...
          <div className="col-md-12  ">
            <input
              ...
              placeholder="company address"
              onChange={(e) =>
                handelChange("billing", "address", e.target.value)
              }
        ...
        <div className="row g-3 ">
          ...
          <div className="col-md-6">
            <input
              ...
              placeholder="company phone"
              onChange={(e) =>
                handelChange("shipping", "phone", e.target.value)
              }
          ...
          <div className="col-md-12  ">
            <input
              ...
              placeholder="company address"
              onChange={(e) =>
                handelChange("shipping", "address", e.target.value)
              }
        ...
        <div className="row g-3 ">
          <div className="col-md-4">
            ...
            <input
              ...
              onChange={(e) =>
                handelChange("invoice", "number", e.target.value)
              }
            />
          </div>
          <div className="col-md-4">
          ...
          <div className="col-md-4">
            ...
            <input
              ...
              onChange={(e) =>
                handelChange("invoice", "dueDate", e.target.value)
              }
            />
          </div>
        </div>
          ...
          <div key={index} className="card p-3 mb-3">
            <div className="row g-3 mb-2">
              <div className="col-md-3 ">
                <input
                  ...
                  value={item.name}
                  onChange={(e) =>
                    handelItemChange(index, "name", e.target.value)
                  }
                />
              </div>
              <div className="col-md-3 ">
                <input
                  ...
                  value={item.qty}
                  onChange={(e) =>
                    handelItemChange(index, "qty", e.target.value)
                  }
                />
              </div>
              <div className="col-md-3 ">
                <input
                  ...
                  value={item.amount}
                  onChange={(e) =>
                    handelItemChange(index, "amount", e.target.value)
                  }
                />
              </div>
              <div className="col-md-3 ">
                <input
                  ...
                  value={item.total}
                  onChange={(e) =>
                    handelItemChange(index, "total", e.target.value)
                  }
                />
              </div>
            </div>
            <div className="d-flex gap-2">
              <textarea
                ...
                onChange={(e) =>
                  handelItemChange(index, "description", e.target.value)
                }
              ></textarea>
        ...
        <div className="row g-3 ">
          ...
          <div className="col-md-4">
            <input
              ...
              onChange={(e) =>
                handelChange("account", "number", e.target.value)
              }
            />
          </div>
          <div className="col-md-4">
            <input
              ...
              onChange={(e) =>
                handelChange("account", "ifscCode", e.target.value)
              }
            />
          </div>
        </div>
